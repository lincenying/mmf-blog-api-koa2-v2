...
exports.get = async ctx => {
    ...
    try {
        ...
        ctx.error(null, '', { code: 300, ok: 2, msg: error.toString() })
    }
}

exports.card = async ctx => {
    const card_id = ctx.query.card_id
    const block_id = ctx.query.block_id
    const page = ctx.query.page || 1
    if (!card_id || !block_id) {
        ctx.error(null, '', { ok: 2, msg: '参数错误' })
        return
    }
    const options = {
        method: 'GET',
...
exports.video = async ctx => {
    const since_id = ctx.query.since_id || ''
    const options = {
        method: 'GET',
...
exports.beautyVideo = async ctx => {
    const key = encodeURIComponent(ctx.query.key)
    const page = ctx.query.page || 1
    const options = {
        method: 'GET',
...
exports.detail = async ctx => {
    ...
    if (!id) {
        ctx.error(null, '', { code: 301, ok: 2, msg: '参数错误' })
        return
    }
    try {
        const options = {
